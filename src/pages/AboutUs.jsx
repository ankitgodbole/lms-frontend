  ...
  return (
    <HomeLayout>
      <div className="bg-base-100 p-7 text-base-content">
          ...
          <div className="max-w-6xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-10">
            ...
            <div className="text-center md:text-left flex-1 space-y-6">
              ...
              <div className="text-center md:text-left">
                <Link
                  to="/courses"
                  className="inline-block bg-yellow-400 hover:bg-yellow-500 text-[#0d1117] font-semibold py-3 px-6 rounded-full shadow-md transition duration-300"
                >
                  Explore Resources
                </Link>
              </div>
            ...
            <div className="flex-1 w-full">
              <img
                ...
                className="w-full max-w-md lg:max-w-lg mx-auto drop-shadow-xl rounded-3xl"
              />
            </div>
          </div>
        </section>
        ...
        {/* Who We Are */}
        <section className="bg-[#0d111772] my-20 rounded-3xl text-white py-16 px-4 sm:px-8 md:px-16 lg:px-24 relative overflow-hidden">
          <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center gap-12">
            ...
            <div className="text-center md:text-left flex-1 space-y-6">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-400 leading-relaxed max-w-2xl mx-auto md:mx-0">
                ...
                <span className="text-yellow-300 font-medium">accessible</span>{" "}
                — especially for{" "}
              ...
              <div className="text-center md:text-left">
                <Link
                  to="/our-story"
                  className="inline-block bg-yellow-400 hover:bg-yellow-500 text-[#0d1117] font-semibold py-3 px-6 rounded-full shadow-lg transition duration-300"
                >
                  Read Our Story
                </Link>
              </div>
        ...
        {/* What We Offer */}
        <section className="bg-gray-700 py-16 px-4 sm:px-6 md:px-20 rounded-3xl">
          <h2 className="text-2xl md:text-3xl text-gray-100 font-bold text-center mb-12">
            What We Offer
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {/* Card 1 */}
            <div className="bg-[#7d9ec5b8] rounded-xl p-6 min-h-[250px] shadow-lg hover:shadow-xl transition-all text-center">
        ...
        <section className="py-16 px-4 text-center">
          ...
          <Link
            to="/signup"
            className="inline-block px-8 py-3 bg-yellow-400 hover:bg-yellow-500 text-black font-semibold rounded-md shadow-md transition-all"
          >
            Get Started Now
          </Link>
        </section>
